...
--
-- Servidor: 127.0.0.1
-- Tiempo de generaci�n: 05-08-2014 a las 19:16:07
-- Versi�n del servidor: 5.5.36
-- Versi�n de PHP: 5.4.27
...
(4, 'Programaci�n Web', '<p>Somos unos tigres del PHP y dem&aacute;s hierbas</p>\r\n', 'servicios/programacion-web', '2014-07-10 22:47:08', '2014-07-17 13:50:46', 1, 1),
...
(11, 'Drupal 7', '<h1> El Mejor CMS del mundo</h1>\r\n<h2> Que lo usa hasta el t�o Obama<h2>', 'servicios/desarrollo-de-portales/drupal', '2014-07-22 08:05:00', NULL, 1, 1);
...
('guest', 'Usuarios an�nimos, por defecto pueden acceder a todos los contenidos'),
